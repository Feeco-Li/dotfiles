...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  ...
  <tr><th colspan="2"><input type="text" readonly value="section_name"></th></tr>
  <tr><td><a href="#">api_code</a></td><td>description</td></tr>
  ...

  <tr><th colspan="2"><input type="text" readonly value="next_section"></th></tr>
  <tr><td><a href="#">api_code</a></td><td>description</td></tr>
  ...
...
- 2 columns: left = code, right = description
...
```html
<tr><td><a href="#">docker run -d --name &lt;n&gt; &lt;img&gt;</a></td><td>run named container detached</td></tr>
```

- `<a href="#">` renders in yellow (`anchor_color` in `~/.w3m/config`)
- wrap `<b>` around `<a>` for bold: `<b><a href="#">code</a></b>`
...
<tr><th colspan="2"><input type="text" readonly value="section_one"></th></tr>
<tr><td><a href="#">command or api</a></td><td>what it does</td></tr>

<tr><th colspan="2"><input type="text" readonly value="section_two"></th></tr>
<tr><td><a href="#">command or api</a></td><td>what it does</td></tr>
...
2. Map each section to a `<th colspan="2"><input readonly>` header row
3. Map each `cmd / desc` pair to a `<tr><td><a href="#">cmd</a></td><td>desc</td></tr>` row
4. Escape `<`, `>`, `&` in command strings
5. Merge related sections if they share the same conceptual topic
6. Open with `w3m filename.html` to verify layout
